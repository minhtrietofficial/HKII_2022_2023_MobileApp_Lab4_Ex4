...
public class ComputerArrayAdapter extends ArrayAdapter<Computer> {
  ...
  public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (row == null) {
      ...
      holder.tvComputerName = row.findViewById(R.id.TV_computer);
      holder.ivComputer = row.findViewById(R.id.IV_computer);
      row.setTag(holder);
    } else {
    ...
    if (computer.isSelected()) {
      holder.ivComputer.setImageResource(R.drawable.user);
    } else {
      holder.ivComputer.setImageResource(R.drawable.fill_user);
    }
    ...
    row.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Toast.makeText(context,
            "COMPUTER IS CLICKED - " + computer.getName(), Toast.LENGTH_SHORT).show();
